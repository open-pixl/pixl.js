...
const char * const lang_ru_RU[_L_COUNT] = {
    ...
    [_L_APP_SET_OLED_CONTRAST] = "Контраст",
    ...
    [_L_APP_SET_APP_MGMT] = "Ярлыки главного меню",
    [_L_15S] = "15 секунд",
    [_L_30S] = "30 секунд",
    [_L_45S] = "45 секунд",
    [_L_1MIN] = "1 минута",
    ...
    [_L_APP_AMIIDB_NOT_SUPPORT_V3] = "Поддержка Amiibo V3\n не реализована!",
    ...
    [_L_APP_CHAMELEON_CARD_ADV_LOAD_BLOCK0] = "Загрузить из блока 0...",
    [_L_APP_CHAMELEON_CARD_ADV_LOAD_BLOCK0_SUCCESS] = "Данные из блока 0\n загружены",
