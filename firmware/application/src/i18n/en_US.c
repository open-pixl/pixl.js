...
const char * const lang_en_US[_L_COUNT] = {
    ...
    [_L_APP_SET_RETURN_KEY_DETECT] = "Detect Return Button",
    [_L_APP_SET_RETURN_KEY] = "Return Button",
    [_L_APP_SET_RETURN_KEY_NOT_CONFIGURED] = "Not configured",
    [_L_APP_SET_RETURN_KEY_SET] = "Return button set: GPIO %u",
    [_L_APP_SET_RETURN_KEY_NOT_DETECTED] = "Return button not detected",
    [_L_APP_SET_RETURN_KEY_DETECT_RUNNING] = "Detection already running",
    [_L_APP_SET_RETURN_KEY_DETECT_PROMPT] = "Press physical Return button",
    [_L_APP_SET_RETURN_KEY_DETECT_FAILED] = "Cannot start return detect",
    [_L_15S] = "15 Seconds",
    [_L_30S] = "30 Seconds",
    [_L_45S] = "45 Seconds",
    [_L_1MIN] = "1 Minute",
